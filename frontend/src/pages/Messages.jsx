    ...
    <div className="h-[calc(100vh-100px)] flex flex-col bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
      ...
      <div className="p-4 bg-white border-t border-gray-100">
        ...
        <button 
          type="submit" 
          disabled={!text.trim()}
          className="w-auto px-4 h-10 bg-blue-600 hover:bg-blue-700 text-white rounded-full flex items-center justify-center gap-2 transition-transform hover:scale-105 disabled:opacity-50 disabled:scale-100"
        >
